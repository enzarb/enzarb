...
const SettingsSchema = z.object({
	...
	vcpuHoursPerUnit: posNum({ min: 0 }),
	memGiBHoursPerUnit: posNum({ min: 0 }),
	blockStorageGiBMonthsPerUnit: posNum({ min: 0 }),
	registryGiBMonthsPerUnit: posNum({ min: 0 }),
	...
	freeVCPUHours: posNum({ min: 0 }),
	freeMemGiBHours: posNum({ min: 0 }),
	freeBlockStorageGiBMonths: posNum({ min: 0 }),
	freeRegistryGiBMonths: posNum({ min: 0 }),
...
export const updateAdminSettings = form(SettingsSchema, async (v) => {
	...
	await updateSettings({
		...
		pricing_vcpu_hours_per_unit: v.vcpuHoursPerUnit,
		pricing_mem_gib_hours_per_unit: v.memGiBHoursPerUnit,
		pricing_block_storage_gib_months_per_unit: v.blockStorageGiBMonthsPerUnit,
		pricing_registry_gib_months_per_unit: v.registryGiBMonthsPerUnit,
		...
		pricing_free_vcpu_hours: v.freeVCPUHours,
		pricing_free_mem_gib_hours: v.freeMemGiBHours,
		pricing_free_block_storage_gib_months: v.freeBlockStorageGiBMonths,
		pricing_free_registry_gib_months: v.freeRegistryGiBMonths,
